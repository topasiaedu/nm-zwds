# NM-ZWDS Documentation

Welcome to the NM-ZWDS (紫微斗数) project documentation. This directory contains comprehensive documentation for the application.
...
- [**Data Flow**](./architecture/DATA_FLOW.md) - How data moves through the app
