  ...
  "Educators": {
    ...
    "career_paths": {
      ...
      "non_ideal": [
        ...
        "Repetitive Manual Labor without Room for Thought",
        "Brand Marketing with Manipulative Tactics",
        "Performance-Only Academic Roles",
        "Gatekeeping Positions in Competitive Academia",
        "Corporate Legal Drafting or Compliance Auditing"
      ]
    }
  },
  "Strategists": {
    "description": "You are a master of clarity in complexity, navigating uncertainty with calm precision and foresight. Where others see chaos or constraint, you see opportunity, alignment, and a path forward. Analytical yet intuitive, you craft long-term vision through short-term action, connecting patterns across time, terrain, and people. Your mind is not just sharp—it’s structured for impact, turning insight into influence with thoughtful elegance.\nMore than a planner, you are a compass for progress. You weigh consequence with care, always seeking the highest outcome—not just for efficiency, but for integrity. In your leadership, intention meets execution. Your ability to map possibilities and anticipate outcomes creates not only successful initiatives but sustainable momentum. You remind others that behind every bold move lies thoughtful design—and that strategy, at its best, is an act of service.",
    "career_paths": {
      "ideal": [
  ...
  "Guardians": {
    ...
    "career_paths": {
      ...
      "non_ideal": [
        ...
        "Workplaces With No Accountability or Oversight",
        "Performance-Based Politics",
        "Luxury Sales or Brand Elitism",
        "Surveillance for Profit-Driven Entities",
        "Gig-Based Instability Without Protection"
      ]
    }
  },
  "Vanguards": {
  ...
  "Advisors": {
    ...
    "career_paths": {
      ...
      "non_ideal": [
        ...
        "Event Management Without Reflection",
        "Scripting or Messaging Roles in Political Spin",
        "Franchise Management Without Vision",
        "Careers with Fast Deadlines & Little Listening"
      ]
    }
  },
  "Visionaries": {
    ...
    "career_paths": {
      ...
      "non_ideal": [
        ...
        "Real Estate Sales",
        "Corporate Consulting or Business Analysis",
        "Standardized Test Prep or Traditional Teaching",
        "Call Center or Customer Service Roles",
        "Mass-Produced Product Sales"
      ]
    }
  }
} as const;