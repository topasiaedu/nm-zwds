  ...
  Lifekeepers: {
    ...
    career_paths: {
      ideal: [
        ...
        "Doula Services (Birth or End-of-Life)",
        ...
        "Ecospiritual or Nature-Based Work",
        "Care-Focused Educational Roles"
      ],
      non_ideal: [
        "Corporate Law or Litigation",
        "Competitive Finance",
        "Burnout-Driven Startups",
        "Rigid Bureaucracies",
        "Vanity-Focused Fashion Retail"
      ]
    },
  },
  Educators: {
    ...
    career_paths: {
      ideal: [
        ...
        "Museum or Informal Education",
        "Alternative Teaching Models",
        "Instructional Design or EdTech",
        "Librarianship or Archival Studies",
        "Literary Scholarship",
        "Youth Development and Advocacy",
        "Cross-Cultural or Language Education",
        "Philosophy or Ethics Teaching"
      ],
      non_ideal: [
        "Standardized Test Prep",
        "Rigid Corporate Training",
        "Overcrowded Institutional Teaching",
        "Bureaucratic School Admin",
        "High-Pressure EdTech Startups"
      ]
    },
  },
  Strategists: {
    ...
    career_paths: {
      ideal: [
        ...
        "Ethical Operations Leadership",
        "Public Policy Foresight",
        "Urban or Transport Planning",
        "Crisis Management Strategy",
        "Sustainable Development Planning",
        "Game Theory or Simulation Design",
        "Systems Thinking in Nonprofits",
        "Ethical Security Intelligence",
        "Cross-Sector Mediation"
      ],
      non_ideal: [
        "Chaotic Freelance Work",
        "Labor Without Strategic Impact",
        "Art Without Structural Basis",
        "Theoretical Academia Without Use",
  ...
  Architects: {
    ...
    career_paths: {
      ideal: [
        ...
        "Experience or Environment Design",
        "Blueprint Development",
        "Values-Based Process Optimization",
        "Sustainable Architecture",
        "Immersive Game or World Design",
        "Educational or Nonprofit Frameworks",
        "Public Service Design",
        "Policy or Legal Framework Drafting"
      ],
      non_ideal: [
        "Improvised Creative Work",
        "Theoretical Research Without Use",
        "Art Roles With No Structure",
        "Shallow Sales Positions",
        "Short-Term Freelance Without Ownership"
      ]
    },
  },
  Stewards: {
    ...
    career_paths: {
      ideal: [
        ...
        "Crisis Social Work or Advocacy",
        "Conflict Mediation",
        "Judicial or Ethical Oversight",
      ...
      non_ideal: [
        "Celebrity Media or PR",
        "Manipulative Marketing",
        "Trend-Driven Startups",
        "Abstract Art Without Purpose",
        "Toxic Corporate Competition"
      ]
    },
  },
  Guardians: {
  ...
  Vanguards: {
    ...
    career_paths: {
      ideal: [
        ...
        "Activism or Grassroots Organizing",
        "Wilderness or Expedition Leadership",
        "Futurism & Strategic Innovation",
        "Sustainable Tech R&D",
        "Ethical DEI Leadership"
      ],
      non_ideal: [
        "Maintenance Roles Without Growth",
        "Repetitive Manual Work",
        "Rigid Corporate Bureaucracy",
        "Autonomy-Lacking Customer Service",
        "Traditional Academia Without Change"
      ]
    },
  },
  Advisors: {
    ...
    career_paths: {
      ideal: [
        ...
        "Diplomatic Advising",
        "Ethics or Spiritual Guidance",
        "Creative or Strategic Mentorship",
        "Think Tank or Policy Advisory",
        "Conscious Leadership Consulting",
        "Psychological Development",
        "Conflict Mediation",
        "Philosophy or Conscious Studies",
        "Curated Community Leadership"
      ],
      non_ideal: [
        "Performance Sales",
        "Shallow Content Creation",
        "Inauthentic Brand Work",
        "Hustle Culture",
        "Aggressive Coaching"
      ]
    },
