...
export const DATASET_1 = {
  ...
  武曲: {
    ...
    财帛宫: {
      ...
      quote: "You are not a salary earner, you are a result-driven operator.",
    },
    官禄宫: {
      title: "⚔️ 武曲（官禄宫）｜执行星",
      description:
  ...
  天机: {
    ...
    官禄宫: {
      ...
      quote:
        "You are the person who can break down the world, you don't need to change everything, you just need to design a smarter rule.",
    },
  },
  文曲: {
    type: "感性艺术星",
    ...
    财帛宫: {
      ...
      quote: "You can make money because you can move people.",
    },
    官禄宫: {
      title: "🎼 文曲（官禄宫）｜感性艺术星",
      description:
  ...
  贪狼: {
    ...
    财帛宫: {
      ...
      quote: "Your style is the most profitable brand.",
    },
    官禄宫: {
      title: "🐺 贪狼（官禄宫）｜魅力星",
      description:
  ...
  巨门: {
    ...
    官禄宫: {
      ...
      quote: "You are not necessarily liked, but you are worth being trusted.",
    },
  },
  天同: {
    type: "天真疗愈星",
  ...
  左輔: {
    ...
    财帛宫: {
      ...
      quote: "Your wealth comes from win-win, not from winning alone.",
    },
    官禄宫: {
      title: "🫱 左輔（官禄宫）｜辅佐星",
      description:
  ...
  右弼: {
    ...
    财帛宫: {
      ...
      quote: "Your relationships are your capital.",
    },
    官禄宫: {
      title: "🤝 右弼（官禄宫）｜辅佐星",
  ...
  天梁: {
    ...
    财帛宫: {
      ...
      quote: "Helping others is also a way to achieve wealth for you.",
    },
    官禄宫: {
      title: "🧱 天梁（官禄宫）｜辅佐星",
  ...
  廉贞: {
    ...
    财帛宫: {
      ...
      quote: "Your ambition is worth the resources.",
    },
    官禄宫: {
      title: "🔥 廉贞（官禄宫）｜斗志星",
      ...
      quote: "You drive change, and can also stabilize the whole situation.",
    },
  },
};

export const TIP_CONSTANTS = {
  命宫: {
    紫微: "学习做决策，用稳定的心养稳团队",
    天府: "在稳定的基础上，尝试创新和突破",
    天相: "在协调他人的同时，关注自身需求",
    武曲: "学习适度柔软，你的价值不只是做完任务，还要被看见、被珍惜",
    天机: "开始执行比思考更重要，练习让一个想法跑到终点",
    文曲: "培养稳定输出能力／情绪不再控制你，而是被你转化成灵感",
    文昌: "让表达更接地气／不要怕重复／一支笔可以换一座山",
    贪狼: "专注做出一个让你又爱又赢的系统，不再只是体验而已",
    太阳: "你不是一个人照亮世界的人，你也值得被别人照亮",
    太阴: "你不是脆弱，你是内在深不可测的能量海",
    巨门: "你不是吵架王，你是语言的解毒剂",
    天同: "你不是软弱，你是以柔克刚的光之人",
    七杀: "你不是坏脾气，你是带着刀锋来的命运工程师",
    破军: "你不是一直在重启，而是在打造最强版本的自己",
    左輔: "学习设界限，在给予中不失自我",
    右弼: "学会表达真实感受，平衡自己与他人",
    天梁: "学会区分责任界线，不为所有人负责",
    廉贞: "整合情绪与行动，让锋芒更有方向"
  ...
  财帛宫: {
    ...
    天府: "在稳健的基础上，适度冒险，抓住机会",
    天相: "清楚表达价值／创造信任通路／定价别再退",
    武曲: "建立属于自己的「高价服务系统」，提升每小时单位产值",
    天机: "选一个最有机会长期跑赢的方向深耕，别把能量分给太多细枝末节",
    文曲: "建立感性产出结构化系统——打造情绪能卖钱的产品线",
    文昌: "提升内容变现速度、打造一套有结构的知识型产品并持续销售",
    贪狼: "打造独特个性变现系统／设定赚钱纪律／找理性合伙人做后盾",
    太阳: "练习带出价值感的主张／敢亮出价格与框架／定时回收信任红利",
    太阴: "建立服务结构／打造长期稳定客户池／设定定价底线",
    巨门: "打造敢说真话的变现模型，建立高信任社群",
    天同: "建立疗愈型服务收费模型，把温柔定价，让温暖变被动收入",
    七杀: "打造快而稳的金流策略、练习止盈纪律、带团队控节奏",
    破军: "建立短打赢收口流程／打造多渠道流量变现系统",
    左輔: "设好合作条件，争取应得报酬",
    右弼: "建立清晰界限，资源换位合理",
    天梁: "在利他中学会定价，让价值被看见",
    廉贞: "培养长期思维，累积稳健资产"
  ...
  官禄宫: {
    ...
    天府: "在稳定的基础上，尝试创新和突破",
    天相: "练习边界感／明确职掌与KPI／打造可复制的协作模式",
    武曲: "打造「带人系统」而不是「做事系统」，让你从个人强转团队强",
    天机: "搭配表达型合伙人／打造个人策略品牌／建立高单价智力服务系统",
    文曲: "结合结构型合伙人，把你的灵感转化为实际可售产品或服务",
    文昌: "练习80分就推、内容先上线再优化，让你的知识真正开始变现",
    贪狼: "建立玩中赢系统，让创意有结构、情绪有出口、事业有节奏",
    太阳: "打造带人系统／建立领导力赢利方程式",
    太阴: "打造专业定位／练习温和地表达野心",
    巨门: "团队搭配表达者＋执行者＋信任构建者",
    天同: "把你的温柔建立成影响力系统，让安静的你也能稳收事业红利",
    七杀: "建立可传承系统／打造自由有边界个人品牌",
    破军: "打造破局→变现→带人三部曲结构，放大独特风格变资产",
    左輔: "提升专业能力，发出你的影响力",
    右弼: "练习理性表达，做出理智决策",
    天梁: "增强决断力，守护也能立威",
    廉贞: "融入团队，激烈中保留圆润"
...
export const STRENGTH_CONSTANTS = {
  ...
  天府: ["稳重", "可靠", "管理能力强"],
  天相: ["温和", "善于协调", "人际关系好"],
  武曲: ["高执行力", "有纪律", "踏实不虚", "目标导向强"],
  天机: ["反应快", "思考深", "策略性强", "灵活不僵化"],
  文曲: ["情绪细腻", "创意强", "艺术细胞高", "写得动人"],
  文昌: ["脑子清楚", "讲得有条理", "文笔扎实", "反应快"],
  贪狼: ["魅力值高", "社交高手", "善于创意表现与感官体验"],
  太阳: ["有魄力", "有责任感", "正义感强", "能带人", "有愿景"],
  太阴: ["细腻", "温柔", "温和耐心", "思虑周全", "情绪调和力强"],
  巨门: ["敢讲实话", "逻辑清晰", "观察力强", "表达有杀伤力"],
  天同: ["心态正向", "善解人意", "和平使者", "温柔包容", "有疗愈力"],
  七杀: ["执行爆发力强", "果决", "独立", "敢冒险", "创新破局"],
  破军: ["破旧立新力强", "适应力强", "有改革能量", "天生带冲劲"],
  左輔: ["忠诚", "温和", "乐于助人"],
  右弼: ["圆融", "善交际", "可靠"],
  天梁: ["正义感强", "包容", "有医护能量"],
  廉贞: ["果断", "有魅力", "有野心"],
