...
export const PALACE_GUIDANCE_DATA: Record<string, PalaceGuidanceData> = {
  "官禄": {
    keyActions: [
      "Negotiate for a higher compensation package, equity, or expanded operational control.",
      "Launch the new product line, service offering, or strategic initiative you have been planning.",
      "Position yourself for a promotion or leadership role by taking ownership of a high-visibility project.",
      "Audit your current role: if the ROI on your time has plateaued, initiate an exit or pivot strategy.",
      "Leverage your track record to secure better terms on your next major contract or role.",
      "Step into the spotlight: ensure key decision-makers associate your name with revenue or impact.",
    ],
    watchOut: [
      "Accepting increased responsibilities without a corresponding increase in compensation or leverage.",
      "Focusing on operational execution instead of strategic visibility.",
      "Waiting passively for opportunities instead of engineering them.",
      "Letting comfort dictate your career trajectory.",
      "Using tenure as an excuse instead of adapting to new market demands.",
      "Staying quiet during a window designed for aggressive expansion.",
    ],
    successMetrics: [
      ...
      "Clear exit strategy defined for underperforming roles",
    ],
    reflectionQuestions: [
      ...
      "Am I operating as a strategist or just a high-paid executor?",
  ...
  "迁移": {
    keyActions: [
      "Expand into a new market, geography, or demographic to capture unexploited opportunities.",
      "Attend high-level industry events to position yourself in front of new decision-makers.",
      "Test a new distribution channel or networking strategy outside your standard playbook.",
      "Relocate capital or focus to a more strategically advantageous environment.",
      "Build strategic alliances in territories or departments where you currently have zero footprint.",
      "Take calculated risks to disrupt your own career model before the market forces you to.",
    ],
    watchOut: [
      "Scaling into new markets before your core foundation is stable.",
      "Treating travel as a vacation instead of a strategic networking and expansion opportunity.",
      ...
      "Expanding without a clear thesis on how the new environment drives ROI.",
    ],
    successMetrics: [
    ...
    reflectionQuestions: [
      ...
      "Is my current environment still supporting my growth, or capping my leverage?",
  ...
  "交友": {
    keyActions: [
      "Identify the three nodes in your network who have access to the opportunities you need next.",
      "Propose a structured, mutually beneficial collaboration or referral agreement.",
      "Audit your professional circle and cut ties with low-ROI or capacity-draining commitments.",
      "Host an exclusive dinner or mastermind to position yourself as a connector in your industry.",
    ...
    watchOut: [
      "Deploying time and attention into relationships based on history rather than strategic alignment.",
    ...
    successMetrics: [
      ...
      "Network audited and low-ROI commitments eliminated",
    ...
    reflectionQuestions: [
      ...
      "Which relationships are costing me more capacity than they generate?",
    ],
  },
  "财帛": {
    keyActions: [
      "Liquidate underperforming assets or side-projects and reallocate into higher-yield positions.",
      "Raise your rates, negotiate a raise, or increase your product pricing.",
      "Launch the secondary income stream or monetization engine you have been building.",
      "Audit your personal P&L: cut low-value expenses and eliminate operational bloat.",
      "Leverage your existing network to secure better terms on financial opportunities.",
      "Convert accumulated skills, IP, and knowledge into scalable income streams.",
    ],
    watchOut: [
      "Parking capital in low-yield accounts without reviewing performance.",
      "Ignoring that you've been on the wrong financial path and refusing to cut losses.",
      "Sitting on valuable skills or IP without packaging or monetizing them.",
      "Waiting for a windfall instead of engineering a liquidity event.",
      "Letting resources collect dust when they could be deployed for leverage.",
    ...
    successMetrics: [
      ...
      "Skills or IP packaged and monetized",
      "Personal P&L audited and expenses reduced",
    ],
    reflectionQuestions: [
      "What assets do I own that are not generating an acceptable yield?",
      "When was the last time I aggressively audited my compensation or pricing strategy?",
      "What skills or IP could I monetize immediately?",
      "Am I actively managing my capital, or just hoping it compounds?",
      "Where am I leaving money on the table out of fear or complacency?",
    ],
  },
  "田宅": {
    keyActions: [
      "Review and optimize your real estate portfolio, leases, or foundational physical assets.",
      "Refinance debt, renegotiate terms, or leverage existing equity to fund your next move.",
      "Invest in upgrading your core operational infrastructure or personal backend systems.",
      "Secure your intellectual property, personal brand assets, and foundational stability.",
    ...
    watchOut: [
      ...
      "Relying on outdated asset management strategies without proper market research.",
      "Sitting on equity goldmines without deploying them for leverage.",
      "Allowing foundational cracks in your personal operations to go unaddressed.",
      "Ignoring family or partnership tensions that threaten your core stability.",
    ],
    successMetrics: [
      "Asset portfolio optimized for increased yield or reduced cost",
      "Operational infrastructure or personal systems upgraded",
      "Debt refinanced or equity leveraged strategically",
      "Intellectual property or foundational assets secured",
      "Market research completed to inform next asset acquisition",
    ],
    reflectionQuestions: [
      ...
      "Are my key partnerships supporting or threatening my core stability?",
      "What upgrades would maximize the valuation of my current portfolio?",
      "Am I leveraging my equity effectively, or just sitting on it?",
    ],
  },
  "福德": {
    keyActions: [
      "Hire an executive coach, therapist, or advisor to eliminate your strategic blind spots.",
      "Take a dedicated off-site strategy week to map your next 12-month career and financial plan.",
      "Audit your decision-making patterns: where are you leaving money on the table out of fear?",
    ...
    watchOut: [
      "Burning out by pouring into output without internal recovery and strategic reflection.",
      ...
      "Sabotaging your wealth accumulation through unexamined psychological patterns.",
    ...
    successMetrics: [
      ...
      "Psychological bottlenecks to wealth accumulation cleared",
      "Mental capacity and focus noticeably increased",
    ],
    reflectionQuestions: [
      "What psychological patterns are sabotaging my financial success?",
      "Do I trust my strategic instincts, or constantly second-guess my decisions?",
      "Am I operating from a place of leverage or a place of fear?",
      "What would change if my internal state matched my financial ambitions?",
  ...
  "夫妻": {
    keyActions: [
      ...
      "Formalize the terms, splits, and contributions of your key professional partnerships.",
      "Address operational bottlenecks with key collaborators immediately to protect your bandwidth.",
    ...
    successMetrics: [
      ...
      "Partnership terms, equity, and exit strategies formalized",
      "Operational bottlenecks with key partners resolved",
      "Two-yes rule established for major commitments",
      "Emotional clutter eliminated through direct communication",
    ],
    reflectionQuestions: [
      "Is this partnership amplifying my leverage or draining my capacity?",
  ...
  "兄弟": {
    keyActions: [
      "Audit your peer collaborations and cut ties with colleagues who drain your capacity.",
      "Identify peers who have complementary leverage and propose a structured exchange.",
    ...
    successMetrics: [
      ...
      "Structured exchanges of leverage established with key peers",
    ...
    reflectionQuestions: [
      ...
      "Who am I keeping around out of obligation rather than strategic value?",
  ...
  "子女": {
    keyActions: [
      "Set strict, 90-day measurable milestones for any junior talent or project you are funding.",
      "Cap the financial and operational runway you provide to underperforming initiatives.",
      "Structure your legacy: update your estate planning, trusts, and long-term asset plans.",
      "Delegate operational tasks to junior team members so you can focus on high-leverage strategy.",
    ...
    watchOut: [
      ...
      "Carrying your team's operational problems like they are your own.",
      "Letting guilt or frustration dictate how you manage your subordinates.",
      "Leaving your legacy or succession plan scattered without proper legal structure.",
    ...
    successMetrics: [
      ...
      "Financial runway capped for underperforming initiatives",
      "Estate planning, trusts, or succession plans updated",
      "Operational tasks successfully delegated",
      "Clear direction established for scalable assets and IP",
    ],
    reflectionQuestions: [
      "Am I funding dependence or funding growth?",
      "What underperforming project or person do I need to cut off?",
      "Is my succession plan and legacy clearly structured legally and financially?",
      "What operational tasks am I hoarding that I should be delegating?",
  ...
  "父母": {
    keyActions: [
      ...
      "Formalize any informal family financial arrangements or eldercare responsibilities with written terms.",
  ...
  "命宫": {
    keyActions: [
      "Invest capital into acquiring a new high-leverage skill or certification.",
      "Rebuild your personal brand and positioning to command a higher market premium.",
      "Audit your daily habits: eliminate the routines that do not serve your financial goals.",
      "Take ownership of your trajectory: stop waiting for permission to make your next move.",
      "Use this window to strengthen your operational foundation before the next expansion phase.",
      "Position yourself as the primary asset in your portfolio and invest accordingly.",
    ],
    watchOut: [
      "Pouring into everyone else's projects while neglecting your own strategic positioning.",
      "Postponing self-investment under the guise of 'responsibility' to others.",
      "Hitting the same compensation or revenue ceiling year after year without upgrading your skills.",
    ...
    successMetrics: [
      "Capital invested in high-leverage skill acquisition or certification",
      "Personal brand and market positioning upgraded",
      "Daily habits audited and unproductive routines eliminated",
      "Personal operational foundation noticeably strengthened",
      "Next-phase strategic positioning finalized",
    ],
    reflectionQuestions: [
      "When was the last time I invested capital directly into my own capability?",
      "What upgraded version of myself does my next financial target require?",
  ...
  "疾厄": {
    keyActions: [
      ...
      "Build sustainable operational routines instead of compensating with sheer willpower.",
    ...
    watchOut: [
      ...
      "Rebuilding your wealth portfolio while destroying the biological vehicle that carries it.",
    ],
    successMetrics: [
    ...
    reflectionQuestions: [
      ...
      "Am I managing my biology as ruthlessly as I manage my career?",
    ],
  },
};
