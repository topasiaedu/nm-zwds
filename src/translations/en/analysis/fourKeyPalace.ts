...
const fourKeyPalace = {
  ...
  fourKeyPalaceContent: {
    ...
    命宫: {
      name: "Destiny Palace",
      keyword: "🧠 Destiny Palace (Appearance/Character/Star Enhancement)",
      meaning: "Self-state, mindset, personality, dominance",
      HuaLu: {
        title: "☀️ Prosperity in Destiny Palace",
      ...
      HuaKe: {
        title: "⚡ Achievement in Destiny Palace",
    ...
    兄弟: {
      ...
      keyword: "👬 Siblings Palace (Brothers & Sisters/Resource Loss)",
      ...
      HuaQuan: {
        title: "⚡ Power in Siblings Palace",
      ...
      HuaKe: {
        title: "💫 Achievement in Siblings Palace",
      ...
      HuaJi: {
        title: "🌀 Obstacle in Siblings Palace",
    ...
    夫妻: {
      ...
      keyword: "❤️ Marriage Palace (Relationship Status/Pre-marriage Relationship)",
      meaning: "Love relationship, partner, long-term pairing interactions",
      HuaLu: {
        title: "☀️ Prosperity in Marriage Palace",
      ...
      HuaQuan: {
        title: "⚡ Power in Marriage Palace",
      ...
      HuaKe: {
        title: "💫 Achievement in Marriage Palace",
      ...
      HuaJi: {
        title: "🌀 Obstacle in Marriage Palace",
    ...
    子女: {
      ...
      keyword: "👶 Children Palace (Fertility/Sex Life/Creative Energy/Team/New Projects)",
      meaning: "Students, children, teams, creative products",
      HuaLu: {
        title: "☀️ Prosperity in Children Palace",
      ...
      HuaQuan: {
        title: "⚡ Power in Children Palace",
      ...
      HuaKe: {
        title: "💫 Achievement in Children Palace",
      ...
      HuaJi: {
        title: "🌀 Obstacle in Children Palace",
    ...
    财帛: {
      name: "Wealth Palace",
      keyword: "💰 Wealth Palace (Money, Cash Flow, Investment, Assets, Long-term Plans)",
      ...
      HuaKe: {
        title: "💫 Achievement in Wealth Palace",
      ...
      HuaJi: {
        title: "🌀 Obstacle in Wealth Palace",
    ...
    疾厄: {
      name: "Health Palace",
      keyword: "🩺 Health Palace (Physical Health, Accidents, Surgery, Emotional Resilience)",
      meaning: "Health condition, psychological emotion, stress management",
      HuaLu: {
        title: "☀️ Prosperity in Health Palace",
      ...
      HuaKe: {
        title: "💫 Achievement in Health Palace",
      ...
      HuaJi: {
        title: "🌀 Obstacle in Health Palace",
    ...
    迁移: {
      name: "Travel Palace",
      keyword: "✈️ Travel Palace (Travel, External Environment, Foreign Destiny)",
      meaning: "External development, foreign opportunities, social occasions",
      HuaLu: {
        title: "☀️ Prosperity in Travel Palace",
      ...
      HuaKe: {
        title: "💫 Achievement in Travel Palace",
      ...
      HuaJi: {
        title: "🌀 Obstacle in Travel Palace",
    ...
    交友: {
      name: "Friends Palace",
      keyword: "🌐 Friends Palace (Social Circles/Benefactors & Troublemakers/Cooperation Luck)",
      meaning: "Social circle, relationship depth, group dynamic",
      HuaLu: {
        title: "☀️ Prosperity in Friends Palace",
      ...
      HuaKe: {
        title: "💫 Achievement in Friends Palace",
      ...
      HuaJi: {
        title: "🌀 Obstacle in Friends Palace",
    ...
    官禄: {
      name: "Career Palace",
      keyword: "🏢 Career Palace (Career Achievement, Stability, Social Status, Promotion, Team, Systematization)",
      meaning: "Career direction, workplace performance, sense of work achievement",
      HuaLu: {
        title: "☀️ Prosperity in Career Palace",
      ...
      HuaJi: {
        title: "🌀 Obstacle in Career Palace",
    ...
    田宅: {
      ...
      keyword: "🏡 Property Palace (Family, Real Estate, Spatial Energy)",
      ...
      HuaKe: {
        title: "💫 Achievement in Property Palace",
    ...
    福德: {
      ...
      keyword: "💫 Happiness Palace (Mental State, Spiritual Thinking, Stress Preferences)",
      meaning: "Mental richness, ability to enjoy, soul nourishment",
      HuaLu: {
        title: "☀️ Prosperity in Happiness Palace",
      ...
      HuaKe: {
        title: "💫 Achievement in Happiness Palace",
      ...
      HuaJi: {
        title: "🌀 Obstacle in Happiness Palace",
    ...
    父母: {
      name: "Parents Palace",
      keyword: "👴 Parents Palace (Parents' Status/Root System/Spiritual Support)",
      meaning: "Relationship with original family, elders, spiritual support",
      HuaLu: {
        title: "☀️ Prosperity in Parents Palace",
      ...
      HuaKe: {
        title: "💫 Achievement in Parents Palace",
      ...
      HuaJi: {
        title: "🌀 Obstacle in Parents Palace",
