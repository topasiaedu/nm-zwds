const chart = {
  ...
  pdfExport: {
    ...
    pageNumber: "Page",
    exporting: "Getting your report ready...",
    ...
    processingChart: "Hang tight—we are putting your report together...",
    progress: "Progress",
    chartName: "Chart",
    ...
    starting: "Getting your report ready...",
    serverRendering: "Sorting your chart into neat pages you can save or print...",
    serverPhase2:
      "Still working—full reports like yours can take a little longer...",
    serverPhase3: "Almost there—just tidying the last details...",
