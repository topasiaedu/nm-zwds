...
/**
 * Gold/amber section card wrapper aligned to the app’s premium Founder Report styling.
 */
const SectionCard: React.FC<{
  ...
  return (
    <div className="rounded-2xl shadow-lg overflow-hidden border bg-white dark:bg-gray-800 border-gray-100 dark:border-gray-700">
      <div className="relative bg-gradient-to-r from-amber-600 to-yellow-500 px-6 py-4 overflow-hidden">
        <div
