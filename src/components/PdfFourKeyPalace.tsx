...
/**
 * Props for the PDF Four Key Palace component
 */
type PdfFourKeyPalaceProps = {
  chartData: ChartData;
};

/**
 * PDF-specific Four Key Palace component optimized for consistent export across devices
 * Layout: Column layout with cards stacked vertically
 */
const PdfFourKeyPalace: React.FC<PdfFourKeyPalaceProps> = ({ chartData }) => {
...
export default PdfFourKeyPalace; 