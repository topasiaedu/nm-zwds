...
export const FEATURE_DESCRIPTIONS: Record<FeatureKey, string> = {
  ...
  hasAlignmentAdvantage: "Alignment Advantage strategic report (timing roadmap, wealth blueprint, playbook).",
  hasMonthlyConsultation: "Premium monthly Liu Yue consultation report (15-chapter Document Viewer + PDF).",
