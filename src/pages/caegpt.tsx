        ...
        <div className="max-w-full mx-auto px-1 sm:px-2 py-2 sm:py-4">
          ...
          <div className="mb-4">
            <div className="flex items-center mb-4 px-2">
              <Link 
                to="/dashboard" 
                className="flex items-center text-indigo-600 hover:text-indigo-800 dark:text-indigo-400 dark:hover:text-indigo-300 mr-4 transition-colors"
              >
          ...
          <div className="w-full max-w-5xl mx-auto">
            <div className="rounded-2xl shadow-2xl overflow-hidden
              ...
              {/* Chat Header */}
              <div className="bg-gradient-to-r from-purple-600/20 to-indigo-600/20 px-2 sm:px-4 py-3 border-b border-white/10">
              ...
              <div className="p-1 sm:p-2">
                <div className="rounded-xl overflow-hidden shadow-inner bg-white/5 dark:bg-black/5">
                  <iframe 
                    ...
                    width="100%" 
                    style={{ height: "100vh", border: "none", width: "100%" }} 
              ...
              <div className="px-2 sm:px-4 py-3 bg-gradient-to-r from-purple-600/10 to-indigo-600/10 border-t border-white/10">
                <div className="flex items-center justify-between text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <div>
                    Powered by Destiny Wealth Navigator AI
                  </div>
                </div>
              </div>
            </div>
