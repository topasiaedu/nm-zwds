          ...
          <div className="mb-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl">
                Tier3 experimental interface with advanced timing controls and palace interaction mapping
              </p>
            </div>
          </div>
          ...
          <div className="mb-8">
            <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-200/50 dark:border-gray-700/50 p-6">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Chart Subject</h2>
              </div>
